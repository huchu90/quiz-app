...
export const questions = [
  ...
  },
  {
    ...
    options: ["1592년", "1492년", "1692년", "1792년"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["1904년", "1907년", "1910년", "1905년"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    category: "한국사",
    difficulty: "medium",
    question: "조선시대 법적 신분제도에서 가장 낮은 계층은?",
    options: ["양반", "중인", "상민", "천민"],
    correctAnswer: 3,
    explanation: "천민은 조선시대 법적 신분제도(양천제)에서 가장 낮은 계층이었습니다."
  },
  {
    id: 43,
    category: "한국사",
  ...
  },
  {
    ...
    category: "한국사",
    difficulty: "medium",
    question: "698년 고구려 유민을 이끌고 발해를 건국한 인물은?",
    options: ["대무예", "장보고", "대조영", "문왕"],
    correctAnswer: 2,
    explanation: "대조영은 698년 동모산에서 발해를 건국하고 고왕(高王)이 되었습니다."
  },
  ...
  },
  {
    ...
    options: ["지평선", "슈바르츠실트 반지름", "특이점", "사건의 지평선"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["수에즈 운하", "키엘 운하", "코린트 운하", "파나마 운하"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    category: "지리",
    difficulty: "medium",
    question: "현재 세계에서 면적이 가장 큰 나라는?",
    options: ["캐나다", "미국", "중국", "러시아"],
    correctAnswer: 3,
    explanation: "러시아는 약 1,710만 km²로 현재 세계에서 면적이 가장 큰 나라입니다."
  },
  {
    id: 68,
    category: "지리",
  ...
  },
  {
    ...
    options: ["1919년", "1939년", "1950년", "1945년"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    category: "일반상식",
    difficulty: "hard",
    question: "1843년 찰스 배비지의 해석기관을 위한 알고리즘을 작성하여 '최초의 프로그래머'로 불리는 인물은?",
    options: ["앨런 튜링", "에이다 러브레이스", "찰스 배비지", "존 폰 노이만"],
    correctAnswer: 1,
    explanation: "에이다 러브레이스는 1843년 찰스 배비지의 해석기관을 위한 알고리즘을 작성하여 최초의 프로그래머로 인정받습니다."
  },
  {
    id: 74,
    category: "일반상식",
  ...
  },
  {
    ...
    category: "일반상식",
    difficulty: "hard",
    question: "1957년 소련이 발사에 성공한 인류 최초의 인공위성 이름은?",
    options: ["아폴로", "보이저", "스푸트니크", "허블"],
    correctAnswer: 2,
    explanation: "스푸트니크 1호는 1957년 10월 4일 소련이 발사한 인류 최초의 인공위성입니다."
  },
  {
    id: 80,
    category: "일반상식",
